...
namespace VirtualMemorySimulator
{
    ...
    {
        public const int CACHE_HIT_CLOCK_CYCLES = 8;
        private const int SETS = 512;
        ...
        public OneTwentyEightBitInstruction search(ulong tag)
        {
            ...
            {
                for (setCounter = 0; setCounter < SETS; setCounter++) // this line is not correct, we need to get the correct set
                {
