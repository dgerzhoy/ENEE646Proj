...
{
    [TestClass()]
    public class dTLBTests
    {
        [TestMethod()]
        public void dTLBTest_All_Valid()
        {
            ...
            {
                Virtual_Addrs[i] =
                    ((ulong)(0x00F & (i % dTLB.ENTRIES)) << 43) |       //5 bit page index (leading bit of 0)
